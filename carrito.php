...
<h6 style="color: #000000; text-decoration: none;">Requiere factura?: </h6><a href="http://localhost/Proyecto%20Final%20Rey/SistemaFacturas/inicio.php"><h6 style="text-decoration: none;">Facturacion</h6></a>
    <section class="py-5">
        <div class="container px-4 px-lg-5">
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    <h4>Monto a Pagar: <span id="total_pagar">0.00</span></h4>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; E&C Website 2022</p>
        </div>
    </footer>
