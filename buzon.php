    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <center><h2>Hola cliente!</h2></center><br>Bienvenido al buzon de quejas y sugerencias!, aqui podra ingresar sus quejas y sugerencias
                 referenntes a la pagina, su opinion nos ayuda a mejorar la calidad de servicio que ofrecemos en E&C. <br>- C<br><br>
                <textarea></textarea>
